 ...
 * Use {@link #addSVBar(com.adafruit.bluefruit.le.connect.app.colorPicker.SVBar)} to add a Saturation/Value Bar. <br>
...
public class ColorPicker extends View {
     ...
     */
    public void setOnColorChangedListener(com.adafruit.bluefruit.le.connect.app.colorPicker.ColorPicker.OnColorChangedListener listener) {
     ...
     */
    public com.adafruit.bluefruit.le.connect.app.colorPicker.ColorPicker.OnColorChangedListener  getOnColorChangedListener() {
     ...
     */
    public void setOnColorSelectedListener(com.adafruit.bluefruit.le.connect.app.colorPicker.ColorPicker.OnColorSelectedListener listener) {
     ...
     */
    public com.adafruit.bluefruit.le.connect.app.colorPicker.ColorPicker.OnColorSelectedListener getOnColorSelectedListener() {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (onColorSelectedListener != null && mCenterNewColor != oldSelectedListenerColor) {
                    onColorSelectedListener.onColorSelected(mPointerColor.getColor());
                    oldSelectedListenerColor = mPointerColor.getColor();
                }
    ...
    public void setNewCenterColor(int color) {
        System.err.println("setNewCenterColor mAngle = " + mAngle);
        float[] newHSV = new float[3];
        float[] oldHSV = new float[3];
        Color.colorToHSV(color, oldHSV);
        color = calculateColor(mAngle);
