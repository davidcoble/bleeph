...
public class OpacityBar extends View {
     ...
     */
    private com.adafruit.bluefruit.le.connect.app.colorPicker.OpacityBar.OnOpacityChangedListener onOpacityChangedListener;
    ...
    public void setOnOpacityChangedListener(com.adafruit.bluefruit.le.connect.app.colorPicker.OpacityBar.OnOpacityChangedListener listener) {
        this.onOpacityChangedListener = listener;
    }

    public com.adafruit.bluefruit.le.connect.app.colorPicker.OpacityBar.OnOpacityChangedListener getOnOpacityChangedListener() {
