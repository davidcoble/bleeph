...
public class ValueBar extends View {
     ...
     */
    private com.adafruit.bluefruit.le.connect.app.colorPicker.ColorPicker mPicker = null;
     ...
     */
    private com.adafruit.bluefruit.le.connect.app.colorPicker.ValueBar.OnValueChangedListener onValueChangedListener;
    ...
    public void setOnValueChangedListener(com.adafruit.bluefruit.le.connect.app.colorPicker.ValueBar.OnValueChangedListener listener) {
        this.onValueChangedListener = listener;
    }

    public com.adafruit.bluefruit.le.connect.app.colorPicker.ValueBar.OnValueChangedListener getOnValueChangedListener() {
    ...
    private void calculateColor(int coord) {
        ...
        mColor = Color.HSVToColor(new float[] { mHSVColor[0],
                mHSVColor[1],
                (float) (0.1 - (mPosToSatFactor * coord)) });
    }
